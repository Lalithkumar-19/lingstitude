          ...
          <div className="animate-fade-up [animation-delay:200ms]">
            <div className="inline-flex items-center space-x-2 bg-brand-100 bg-opacity-70 backdrop-blur-sm rounded-full px-3 py-1 border border-brand-200 mb-6">
              <span className="text-xs font-medium text-brand-700">
                Career-Focused English Training
              </span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Elevate Your <span className="text-brand-600">Career</span> With
              Professional English
            </h1>
            <p className="text-lg text-muted-foreground mb-8 max-w-lg text-balance">
              Specialized English communication training for
              under-graduates/graduates and working professionals to accelerate
              your career path and stand out in the job market.
            </p>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent flex items-end">
                <div className="p-6 text-white">
                  ...
                  <h3 className="text-xl font-semibold mt-2">
                    English Communication as a Language
                  </h3>
