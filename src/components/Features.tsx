  ...
  const features = [
    {
      ...
      description:
        "Courses designed specifically for career advancement and professional contexts.",
    },
    {
      icon: <Headphones className="h-6 w-6 text-brand-600" />,
      title: "Personalized Coaching",
      description:
        "One-on-one sessions with expert language coaches focused on your career goals.",
    },
    {
      icon: <Globe className="h-6 w-6 text-brand-600" />,
      title: "Global Certification",
      description:
        "Internationally recognized certificates to boost your resume.",
    },
    {
      icon: <Users className="h-6 w-6 text-brand-600" />,
      title: "Networking Opportunities",
      description:
        "Connect with professionals from diverse industries worldwide.",
    },
    {
      icon: <Award className="h-6 w-6 text-brand-600" />,
      title: "Industry Recognition",
      description:
        "Programs endorsed by leading corporations and organizations.",
    },
  ];
      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-up">
          ...
          <p className="text-lg text-muted-foreground text-balance">
            Our English training programs are specifically designed for
            career-minded individuals looking to gain a competitive edge in the
            global job market.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                We follow a proven 4-step methodology that ensures rapid
                progress and practical skill development for real-world
                application.
              </p>
