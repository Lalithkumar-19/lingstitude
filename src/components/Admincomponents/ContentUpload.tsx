    ...
    <div className='mt-10 flex flex-col w-full border  p-4'>
        <h2 className='text-2xl mb-3'>Upload Content</h2>
         <div className="space-y-6 mb-10">
                    ...
                    <Input value={title} onChange={(e)=>setTitle(e.target.value)} placeholder='Enter Title of video'/>
                    <Input  value={videosrc} onChange={(e)=>setVideosrc(e.target.value)} placeholder='Enter valid Video Src'/>
