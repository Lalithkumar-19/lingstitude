...
const languageFeatures: Feature[] = [
  {
    ...
    description: "Enroll in courses with flexible timelines...",
    image: aeasy,
  ...
  },
  {
    ...
    description: "Access study materials, including worksheets...",
    image: usa,
    color: "from-emerald-500/20 to-teal-500/20",
  },
  {
    title: "Vocabulary Builder",
    description: "Expand your vocabulary with quizzes...",
    image: dfd,
    color: "from-pink-500/20 to-rose-500/20",
  },
  {
    title: "Practice Questions",
    description: "Enhance your skills through practice questions...",
    image: qqq,
...
const softSkills: Feature[] = [
  {
    title: "Debate",
    description: "Participate in debates to improve communication...",
    image: deb,
    color: "from-cyan-500/20 to-purple-500/20",
  },
  {
    title: "Discussion",
    description: "Engage in discussions to express ideas clearly...",
    image: dis,
  ...
  },
  {
    ...
    description: "Master impactful presentations...",
    image: pre,
    color: "from-violet-500/20 to-purple-500/20",
  },
  {
    title: "Interactive Skills",
    description: "Develop interpersonal skills...",
    image: inter,
    color: "from-violet-500/20 to-blue-500/20",
  },
  {
    title: "Learn Microsoft Tools",
    description: "Gain proficiency in essential MS Office tools...",
    image: micro,
    color: "from-indigo-400/20 to-purple-500/20",
  },
  {
    title: "AI Tools to Boost Productivity",
    description: "Leverage AI tools to enhance productivity...",
    image: ai,
    color: "from-sky-500/20 to-purple-500/20",
  },
  {
    title: "Interactive Games to Build Networking",
    description: "Enhance networking skills through games...",
    image: interactive,
    color: "from-red-500/20 to-purple-500/20",
  },
  {
    title: "Etiquettes",
    description: "Master professional etiquette for networking...",
    image: etique,
    color: "from-violet-500/20 to-purple-500/20",
  },
];
      ...
      <div className="container px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Join us and take advantage of our resources for language learning
        ...
        >
          <Button
            asChild
            size="lg"
            className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:via-purple-600 hover:to-pink-700 text-white"
          >
            <a
