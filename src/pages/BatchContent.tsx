...
const BatchContent = () => {
  ...
  //           ? "Professional Communication 2023-A"
  //           : "Interview Skills Workshop 2023-B",
  //       description:
  //         batchId === "batch-2023-A"
  ...
  //       startDate:
  //         batchId === "batch-2023-A" ? "September 1, 2023" : "October 5, 2023",
  //       endDate:
  //         batchId === "batch-2023-A"
  //           ? "December 15, 2023"
  //           : "November 30, 2023",
  ...
  //           duration: "60 minutes",
  //           description:
  //             "Learn key phrases and vocabulary for professional settings",
  ...
  //           duration: "75 minutes",
  //           description:
  //             "Master the art of delivering engaging presentations in English",
  ...
  //           duration: "90 minutes",
  //           description:
  //             "Course introduction, expectations, and overview of the curriculum",
  //           teacher: "David Chen",
  //           recording: "#",
  //           materials: [
  //             {
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div>
                      ...
                      {batchData.scheduledClasses.filter(
                        (classSession) =>
                          new Date(classSession.date) > new Date()
                      ).length > 0 ? (
                        <div className="space-y-3">
                                ...
                                <div className="flex flex-wrap gap-2 mb-3">
                                  {classSession.recording && (
                                    <Button
                                      ...
                                      size="sm"
                                      onClick={() =>
                                        handleViewRecording(classSession)
                                      }
                                    >
